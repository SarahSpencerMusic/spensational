			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					<div class="entry-meta">
						...
						<?php edit_post_link( __( 'Edit', 'vinelace' ), '<span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-meta -->
				</header><!-- .entry-header -->
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							<?php vinelace_the_attached_image(); ?>
						</div><!-- .attachment -->
			  ...
			  <nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<span class="previous-image">' . __( 'Previous Image', 'vinelace' ) . '</span>' ); ?>
				<?php next_image_link( false, '<span class="next-image">' . __( 'Next Image', 'vinelace' ) . '</span>' ); ?>
				</div><!-- .nav-links -->
